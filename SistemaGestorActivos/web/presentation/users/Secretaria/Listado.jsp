            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-md-10 col-lg-8">
                        <form class="card card-sm" action="presentation/users/Secretaria/comenzar_filtrado">
            ...
            <div class="table-wrapper-scroll-y my-custom-scrollbar">
                <table class="table table-bordered table-striped mb-0">
                    ...
                    <tr>
                        ...
                        <td> <a href="presentation/users/Secretaria/verSolicitud?idSolicitud=<%=s.getId()%>">Ir a</a></td>
                    </tr>
                    <% }%> 
                </table>
            </div>
